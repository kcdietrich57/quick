...
public abstract class GenericTxn //
	 ...
	 */
	private static enum TxIndexType {
		INSERT, FIRST, LAST
	}

	private static final List<GenericTxn> allTransactionsByID = new ArrayList<GenericTxn>();
	private static final List<GenericTxn> allTransactionsByDate = new ArrayList<GenericTxn>();
